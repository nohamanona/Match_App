...
import kotlinx.android.synthetic.main.activity_man_six_select.*
import kotlinx.android.synthetic.main.activity_man_six_select.BackButton2
import kotlinx.android.synthetic.main.activity_man_six_select.id1
import kotlinx.android.synthetic.main.activity_man_six_select.radioGroup
import kotlinx.android.synthetic.main.activity_man_six_select.textView4

class ManFiveSelectActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_man_five_select)
    ...
    fun onDecisionButtonTapped(view: View){
        ...
        pref.edit {
            putInt("MAN_FIVE_SELECT_WOMAN_NO", ManOneSelectWomanNo)
        }
        if (ParticipantsManNo == 5) {
            val intent = Intent(this, WomanOneSelectActivity::class.java)
            startActivity(intent)
        }
        else{
            val intent = Intent(this, ManSixSelectActivity::class.java)
            startActivity(intent)
        }
    }
}
