...
import kotlinx.android.synthetic.main.activity_man_four_select.*
import kotlinx.android.synthetic.main.activity_man_four_select.BackButton2
import kotlinx.android.synthetic.main.activity_man_four_select.id1
import kotlinx.android.synthetic.main.activity_man_four_select.radioGroup
import kotlinx.android.synthetic.main.activity_man_four_select.textView4

class ManFourSelectActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_man_four_select)
    ...
    fun onDecisionButtonTapped(view: View){
        ...
        pref.edit {
            putInt("MAN_FOUR_SELECT_WOMAN_NO", ManOneSelectWomanNo)
        }
        if (ParticipantsManNo == 4) {
            val intent = Intent(this, WomanOneSelectActivity::class.java)
            startActivity(intent)
        }
        else{
            val intent = Intent(this, ManFiveSelectActivity::class.java)
            startActivity(intent)
        }
    }
}
