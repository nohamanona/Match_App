...
import kotlinx.android.synthetic.main.activity_man_one_select.*

class ManOneSelectActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_man_one_select)
    ...
    fun onDecisionButtonTapped(view: View){
        ...
        pref.edit {
            putInt("MAN_ONE_SELECT_WOMAN_NO", ManOneSelectWomanNo)
        }
        if (ParticipantsManNo == 1) {
            val intent = Intent(this, WomanOneSelectActivity::class.java)
            startActivity(intent)
        }
        else{
            val intent = Intent(this, ManTwoSelectActivity::class.java)
            startActivity(intent)
        }
    }
}
