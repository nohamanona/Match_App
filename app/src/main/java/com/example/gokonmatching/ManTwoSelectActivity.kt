...
import kotlinx.android.synthetic.main.activity_man_two_select.*
import kotlinx.android.synthetic.main.activity_man_two_select.BackButton2
import kotlinx.android.synthetic.main.activity_man_two_select.id1
import kotlinx.android.synthetic.main.activity_man_two_select.radioGroup
import kotlinx.android.synthetic.main.activity_man_two_select.textView4

class ManTwoSelectActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_man_two_select)
    ...
    fun onDecisionButtonTapped(view: View){
        ...
        pref.edit {
            putInt("MAN_TWO_SELECT_WOMAN_NO", ManOneSelectWomanNo)
        }
        if (ParticipantsManNo == 2) {
            val intent = Intent(this, WomanOneSelectActivity::class.java)
            startActivity(intent)
        }
        else{
            val intent = Intent(this, ManThreeSelectActivity::class.java)
            startActivity(intent)
        }
    }
}
