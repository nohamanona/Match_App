...
import kotlinx.android.synthetic.main.activity_woman_five_select.*
import kotlinx.android.synthetic.main.activity_woman_five_select.BackButton2
import kotlinx.android.synthetic.main.activity_woman_five_select.id1
import kotlinx.android.synthetic.main.activity_woman_five_select.radioGroup
import kotlinx.android.synthetic.main.activity_woman_five_select.textView4

class WomanFiveSelectActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_woman_five_select)
    ...
    fun onDecisionButtonTapped(view: View){
        ...
        pref.edit {
            putInt("WOMAN_FIVE_SELECT_MAN_NO", ManOneSelectWomanNo)
        }
        if (ParticipantsWomanNo == 5) {
            val intent = Intent(this, MatchNumActivity::class.java)
            startActivity(intent)
        }
        else{
            val intent = Intent(this, WomanSixSelectActivity::class.java)
            startActivity(intent)
        }
    }
}
