...
import kotlinx.android.synthetic.main.activity_woman_one_select.*
import kotlinx.android.synthetic.main.activity_woman_one_select.BackButton2
import kotlinx.android.synthetic.main.activity_woman_one_select.id1
import kotlinx.android.synthetic.main.activity_woman_one_select.radioGroup
import kotlinx.android.synthetic.main.activity_woman_one_select.textView4

class WomanOneSelectActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_woman_one_select)
    ...
    fun onDecisionButtonTapped(view: View){
        ...
        pref.edit {
            putInt("WOMAN_ONE_SELECT_MAN_NO", ManOneSelectWomanNo)
        }
        if (ParticipantsWomanNo == 1) {
            val intent = Intent(this, MatchNumActivity::class.java)
            startActivity(intent)
        }
        else{
            val intent = Intent(this, WomanTwoSelectActivity::class.java)
            startActivity(intent)
        }
    }
}
