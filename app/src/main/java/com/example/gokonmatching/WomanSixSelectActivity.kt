...
import kotlinx.android.synthetic.main.activity_woman_six_select.*
import kotlinx.android.synthetic.main.activity_woman_six_select.BackButton2
import kotlinx.android.synthetic.main.activity_woman_six_select.id1
import kotlinx.android.synthetic.main.activity_woman_six_select.radioGroup
import kotlinx.android.synthetic.main.activity_woman_six_select.textView4

class WomanSixSelectActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_woman_six_select)
    ...
    fun onDecisionButtonTapped(view: View){
        ...
        pref.edit {
            putInt("WOMAN_SIX_SELECT_MAN_NO", ManOneSelectWomanNo)
        }
