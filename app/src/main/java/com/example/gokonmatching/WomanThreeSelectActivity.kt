...
import kotlinx.android.synthetic.main.activity_woman_three_select.*
import kotlinx.android.synthetic.main.activity_woman_three_select.BackButton2
import kotlinx.android.synthetic.main.activity_woman_three_select.id1
import kotlinx.android.synthetic.main.activity_woman_three_select.radioGroup
import kotlinx.android.synthetic.main.activity_woman_three_select.textView4

class WomanThreeSelectActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_woman_three_select)
    ...
    fun onDecisionButtonTapped(view: View){
        ...
        pref.edit {
            putInt("WOMAN_THREE_SELECT_MAN_NO", ManOneSelectWomanNo)
        }
        if (ParticipantsWomanNo == 3) {
            val intent = Intent(this, MatchNumActivity::class.java)
            startActivity(intent)
        }
        else{
            val intent = Intent(this, WomanFourSelectActivity::class.java)
            startActivity(intent)
        }
    }
}
