...
import kotlinx.android.synthetic.main.activity_woman_two_select.*
import kotlinx.android.synthetic.main.activity_woman_two_select.BackButton2
import kotlinx.android.synthetic.main.activity_woman_two_select.id1
import kotlinx.android.synthetic.main.activity_woman_two_select.radioGroup
import kotlinx.android.synthetic.main.activity_woman_two_select.textView4

class WomanTwoSelectActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_woman_two_select)
    ...
    fun onDecisionButtonTapped(view: View){
        ...
        pref.edit {
            putInt("WOMAN_TWO_SELECT_MAN_NO", ManOneSelectWomanNo)
        }
        if (ParticipantsWomanNo == 2) {
            val intent = Intent(this, MatchNumActivity::class.java)
            startActivity(intent)
        }
        else{
            val intent = Intent(this, WomanThreeSelectActivity::class.java)
            startActivity(intent)
        }
    }
}
